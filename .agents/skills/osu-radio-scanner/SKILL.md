...
5. Update affected guide facts when behavior or contracts change. Keep technical facts in the guide and task procedure here; persistence contracts are documented separately in the database guide.
